            ...
            <div class="card-body">
                <form >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                placeholder="Enter title" value="{{ old('title', $post->title) }}" id="title" readonly>
                            @error('title')
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="text_content" rows="5" class="form-control @error('text_content') is-invalid @enderror"
                                placeholder="Enter content" readonly>{{ old('text_content', $post->text_content) }}</textarea>
                            @error('text_content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-3">
                        <a href="{{ route('admin.posts.index') }}" class="btn btn-dark">
                            Back
                        </a>
