        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="app-brand justify-content-center">
                    <a href="#" class="app-brand-link gap-2">
                        <span class="app-brand-logo demo">
                            ...
                            <span class="app-brand-text demo text-body fw-bolder text-uppercase">BMS</span>
                    </a>
                </div>
                ...
                <form id="formAuthentication" class="mb-3" action="{{ route('admin.post.reset-password') }}"
                    ...
                    <div class="mb-3">
                        <button class="btn btn-danger d-grid w-100" type="submit">Update Password</button>
                    </div>
                    <a href="{{ route('admin.login') }}" class="forgot-link">Sign In</a>
                </form>
            </div>
        </div>
    </div>
